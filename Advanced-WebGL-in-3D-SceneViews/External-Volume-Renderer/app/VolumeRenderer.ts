...
export class VolumeRenderer implements ExternalRenderer {
  ...
  setup(context: RenderContext): void {
    ...
    // const min = [-114.3927221, 52.4202026, 0.035 * 1000];
    // const max = [80.2, -20.7, 19.835 * 1000 * 10]; // exagerate height by 30x
    ...
    selectVolume(
      ...
      () => {
        if (this._updateColorMap) {
          ...
          selectColormap("http://18.222.255.225/ARCGIS-Renderer/Advanced-WebGL-in-3D-SceneViews/External-Volume-Renderer/matplotlib-plasma.png", () => {
            this._updateLegend();
